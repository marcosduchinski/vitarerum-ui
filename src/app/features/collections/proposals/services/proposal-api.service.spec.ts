...
describe('ProposalApiService', () => {
  ...
  it('lists proposals with filters', () => {
    ...
    const request = http.expectOne(
      'https://api.example.test/proposals?status=PENDING&lifecyclePhase=PENDING&type=RESEARCH&requestedBy=permission-external&assignedTo=permission-1&dateFrom=2026-01-01&dateTo=2026-01-31&search=CUP&page=1&size=25',
    );
